...
| Native runtime API, Rust C ABI, or JDK FFM adapter | `:native-runtime-api:check`, focused FFI Rust tests, `:native-runtime-ffm:verifyNativeRuntime`, layout/error/lifetime cases, and a real JVM-to-native integration | `verifyLocalFull` |
